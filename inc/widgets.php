...
if (!function_exists('understrap_widgets_init')) {
	...
	function understrap_widgets_init()
	{
		register_sidebar(
			array(
				'name'          => __('Footer Left Part', 'understrap'),
				'id'            => 'footerleft',
		...
		register_sidebar(
			array(
				'name'          => __('Footer Middle Part', 'understrap'),
				'id'            => 'footermiddle',
				'description'   => __('Full sized footer widget with dynamic grid', 'understrap'),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
		...
		register_sidebar(
			array(
				'name'          => __('Footer Right Part', 'understrap'),
				'id'            => 'footerright',
				'description'   => __('Full sized footer widget with dynamic grid', 'understrap'),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
	...
	function register_custom_sidebar(){
		...
		register_sidebar(
			array(
				'name'          => __( 'Project Sidebar', 'understrap' ),
				'id'            => 'project-sidebar',
				'description'   => __( 'Project sidebar widget area', 'understrap' ),
				'before_widget' => '<div class="widget %2$s">',
				'after_widget'  => "</div>\n",
